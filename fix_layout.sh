...
sed -i 's/<main className="flex-1 w-full max-w-3xl mx-auto p-4 flex flex-col pb-24 relative z-10">/<main className="flex-1 w-full max-w-3xl mx-auto p-4 flex flex-col pb-24 relative z-10 -mt-16 sm:-mt-24">/g' src/components/Layout.tsx
